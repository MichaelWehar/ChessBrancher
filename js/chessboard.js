...
function stopDraggedPiece(location) {
  ...
  if (cfg.hasOwnProperty('onDrop') === true &&
    ...
    var result = cfg.onDrop(containerElOrId, DRAGGED_PIECE_SOURCE, location, DRAGGED_PIECE,
      newPosition, oldPosition, objToFen(newPosition), objToFen(oldPosition), CURRENT_ORIENTATION);
